...
def eval_video(input_data_dump, num_frames_per_video, batch_size, labels, model):
    # Get our data.
...
if __name__ == '__main__':
    ...
    input_data_dump = args.input_file_dumpx
    num_frames_per_video = 25
    batch_size = args.batch_size
    model_file = args.model_file

    eval_video(input_data_dump, num_frames_per_video, batch_size, labels, model_file)